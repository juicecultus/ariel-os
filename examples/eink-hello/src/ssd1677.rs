    ...
    SPI: SpiDevice<u8>,
{
    ...
    pub async fn init(&mut self) {
        ...
        // Booster soft-start (GDEQ0426T82 values, from rust-launcher)
    ...
    pub fn draw_hello_world(&mut self) {
        self.clear_buffer(BinaryColor::Off);
        let style = MonoTextStyle::new(&FONT_10X20, BinaryColor::On);
        Text::new("Hello World!", Point::new(110, 240), style)
            .draw(self)
            .ok();
    }
    ...
    pub async fn refresh(&mut self, mode: RefreshMode) {
        ...
        // Keep RED RAM in sync for next diff update.
        self.set_ram_area(0, 0, PHYSICAL_WIDTH, PHYSICAL_HEIGHT).await;
    ...
    SPI: SpiDevice<u8>,
{
        ...
        I: IntoIterator<Item = Pixel<Self::Color>>,
    {
        for Pixel(point, color) in pixels {
            ...
            {
                // Same mapping as rust-launcher: virtual 480x800 -> physical 800x480
